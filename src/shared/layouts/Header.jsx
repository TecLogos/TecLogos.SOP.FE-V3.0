      ...
      <div className="flex items-center gap-3">
        ...
        <div onClick={handleHome} className="flex items-center gap-2.5 cursor-pointer select-none">
          ...
          <div className="hidden sm:block">
            <p className="text-sm font-bold text-slate-800 leading-none">TecLogos</p>
            <p className="text-[10px] text-slate-500 uppercase tracking-widest font-mono">SOP System</p>
          </div>
        </div>
      </div>
